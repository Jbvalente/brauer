...
public class ClasseParaErrosAttributeTagProcessor extends AbstractAttributeTagProcessor {

	private static final String NOME_ATRIBUTO = "classeparaerros";
	private static final int PRECEDENCIA = 1000;
	
	public ClasseParaErrosAttributeTagProcessor(String dialetoPrefixo) {
		super(TemplateMode.HTML, dialetoPrefixo, null, false, NOME_ATRIBUTO, true, PRECEDENCIA, true );
	}
